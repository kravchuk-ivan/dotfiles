...
module.exports = {
  config: {
    ...
    hypercwd: {
      initialWorkingDirectory: "/users/johannesich/desktop/softeng",
    },
    init: [
      {
        rule: "once",
        commands: ["cd /users/johannesich/Desktop/softeng", "ls"],
    ...
    paneNavigation: {
      ...
      hotkeys: {
        navigation: {
          up: "ctrl+option+up",
          down: "ctrl+option+down",
          left: "ctrl+option+left",
          right: "ctrl+option+right",
        },
        jump_prefix: "ctrl+option", // completed with 1-9 digits
